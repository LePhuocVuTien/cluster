 ...
 */
- (nullable MFMarker *)renderer:(id<GMUClusterRenderer>)renderer markerForObject:(id)object;
 ...
 * item marker.
 */
- (void)renderer:(id<GMUClusterRenderer>)renderer willRenderMarker:(MFMarker *)marker;
 ...
 * item marker.
 */
- (void)renderer:(id<GMUClusterRenderer>)renderer didRenderMarker:(MFMarker *)marker;
 ...
 * region are shown.
 */
@interface MFDefaultClusterRenderer : NSObject<GMUClusterRenderer>
